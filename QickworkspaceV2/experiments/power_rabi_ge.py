"""PowerRabiGE: parameters, native program, analysis and registration in one file."""
...
class PowerRabiGEParameters(Parameters):
...
class PowerRabiGEProgram(BaseProgram):
    TRANSITION = "ge"
...
def build(ctx, p):
    ...
    return ProgramPlan(PowerRabiGEProgram, cfg, (axis,))
