"""T1EF: parameters, native program, analysis and registration in one file."""
...
class T1EFParameters(Parameters):
...
experiment = ExperimentSpec(
    "t1_ef", T1EFParameters, build, analyze, description="T1EF: independently maintained native EF protocol"
)
